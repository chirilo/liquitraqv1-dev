											...
											<div class="flex flex-wrap">
												...
												<div class="w-full mt-3">
													...
													<TextInput id="location_address" type="text"
														placeholder="Location Address" v-model="form.location_address"
														required />
							...
							<div class="grid items-start rounded-lg bg-white p-6 mb-6">
								...
								<div id="recent-jobs">
										...
										<ul class="p-0">
											<li class="mb-6 last:mb-0" v-for="entry in props.liquijobs.slice(0, 3)"
												...
												<div
													...
													<div class="p-3 sm:pr-4 pr-2">
														...
														<h5
															...
															<a :href="route('liquijobs.show', { 'id': entry.id })"
																class="hover:opacity-80">Building: {{
																	entry.corporate_address
																}}</a>
														</h5>
													...
													<div
														class="flex justify-between bg-[#f2f4f7] px-4 py-2  flex-col sm:flex-row">
														<span class="primary-dark-blue font-rethinksansmedium text-base"
															v-if="entry.type === 'facilitydecomissioning'">
															Type: Facility Decomissioning
														</span>
														<span class="primary-dark-blue font-rethinksansmedium text-base"
															v-if="entry.type === 'datacenterdecommissioning'">
															Type: Data Center Decommissioning
														</span>
														<span class="primary-dark-blue font-rethinksansmedium text-base"
															v-if="entry.type === 'officefurniture'">
															Type: Office Furniture
														</span>
														<span class="primary-dark-blue font-rethinksansmedium text-base"
															v-if="entry.type === 'datadestruction'">
															Type: Data Destruction
														</span>
														<span class="primary-dark-blue font-rethinksansmedium text-base"
															v-if="entry.type === 'assetrecovery'">
															Type: Asset Recovery
														</span>
														<span class="primary-dark-blue font-rethinksansmedium text-base"
															v-if="entry.type === 'assetmanagement'">
															Type: Asset Management
														</span>
														<span class="primary-dark-blue font-rethinksansmedium text-base"
															v-if="entry.type === 'recycling'">
															Type: Recycling
														</span>
														<span class="primary-dark-blue font-rethinksansmedium text-base"
															v-if="entry.type === 'generatorremoval'">
															Type: Generator Removal
														</span>
														<span class="primary-dark-blue font-rethinksansmedium text-base"
															v-if="entry.type === 'industrialremoval'">
														...
														<span class="primary-dark-blue font-rethinksansmedium text-base"
															v-if="entry.type === 'infrastructure'">
															Type: Infrastructure
														</span>
														<span class="primary-dark-blue font-rethinksansmedium text-base"
															v-if="entry.type === 'furniture'">
															Type: Furniture
														</span>
														<span class="primary-dark-blue font-rethinksansmedium text-base"
															v-if="entry.type === null">
															Type: Unspecified
														</span>
														<span
															class="text-nowrap w-auto primary-dark-blue font-rethinksansmedium text-base">
									...
									<div v-else class="w-full relative flex flex-col">
										<h1 style="text-align: center;font-size: 1.5em; margin-top: 2em;">No Jobs
											Recorded</h1>
									</div>
								</div>
								<!-- recent jobs -->
								<!-- jobs last 7 days -->
								<div id="job-last-7-days"
									class="mt-6 w-full relative flex flex-col bg-white border border-[#e9ebef] rounded-lg">
									<div class="relative flex flex-col pt-4 sm:pb-2 sm-0 px-4">
										<h3
											class="block w-full text-lg primary-light-blue font-rethinksansextrabold uppercase">
											Jobs Last 7 Days</h3>
									</div>
									<ul class="p-0">
										<li class="px-4 py-2 m-0 last:mb-2 border-b border-[#e9ebef] last:border-none"
											v-for="entry in props.liquijobs.slice(0, 3)" :key="entry.id">
											<div>
												<!-- <PrimaryLink v-if="entry.deleted_at == null" :href="route('liquijobs.show', {'id': entry.id})" class="float-right">View</PrimaryLink> -->
												<a :href="route('liquijobs.show', { 'id': entry.id })"
													class="primary-dark-blue font-rethinksansbold text-base hover:opacity-80">
			...
			<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
				...
				<div class="bg-white rounded-md shadow overflow-x-auto">
					<table class="w-full whitespace-nowrap">
						...
						<tbody>
							<tr v-for="entry in props.liquijobs.data" :key="entry.id"
								...
								<td class="border-t">
									<PrimaryLink v-if="entry.deleted_at == null"
										:href="route('liquijobs.show', { 'id': entry.id })" class="max-w-xl ml-2">VIEW
									</PrimaryLink>
									<PrimaryLink v-if="entry.deleted_at == null"
										:href="route('liquijobs.edit', { 'id': entry.id })" class="max-w-xl ml-2">EDIT
									</PrimaryLink>
									<DangerButton class="ml-3" @click="deleteTrade(entry.id)"
										v-if="entry.deleted_at == null">
										Trash
									</DangerButton>
								</td>
