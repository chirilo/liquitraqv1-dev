							...
							<div class="grid items-start rounded-lg bg-white p-6">
								...
								<div id="recent-jobs">
									<div class="relative flex justify-between items-center">
										...
										<a href="/liquijobs" class="text-white py-2 px-4 rounded-full bg-gradient-blue inline text-center text-xs sm:text-sm font-rethinksansbold hover:opacity-90 flex">
