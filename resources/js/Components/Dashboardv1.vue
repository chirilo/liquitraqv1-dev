...
<template>
    <div>
        <!-- <div class="grid grid-flow-col grid-rows-3 gap-4">
            <div class="row-span-3" style="background-color: gray; padding: 10px;">
                01
                <SearchBarSideBar />
            </div>
            <div class="col-span-3" style="background-color: blue;">
                02
                <center><p>RECENT JOBS</p></center>
            </div>
            <div class="col-span-3 row-span-2" style="background-color: green;">03</div>
        </div> -->
        <main class="mt-6">
            <div class="grid gap-6 lg:grid-cols-2 lg:gap-8" style="display: none;">
                <div
